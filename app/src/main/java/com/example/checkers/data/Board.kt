...
import com.example.checkers.data.constants.CellState
...
class Board {
    ...
    fun canKill(x: Int, y: Int, piece: Piece) : Boolean{
        if(piece.isDame()) {
            return isDiagonalLeftKillable(x, y, piece, Teams.WHITE) || isDiagonalLeftKillable(x, y, piece,
                Teams.BLACK
            ) ||
                    isDiagonalRightKillable(x, y, piece, Teams.WHITE) || isDiagonalRightKillable(x, y, piece,
                Teams.BLACK
            )
        }
